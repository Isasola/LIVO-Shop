    ...
    <main>
      ...
      <section style={{ position:'relative', minHeight:'100vh', display:'flex', flexDirection:'column', overflow:'hidden' }}>
          ...
          <div className="container hero-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:60, alignItems:'center', padding:'100px 24px 60px' }}>
            ...
            <div className="hero-text">
              <div style={{ display:'inline-flex', alignItems:'center', gap:8, background:'rgba(232,120,10,0.12)', border:'1px solid rgba(232,120,10,0.25)', borderRadius:40, padding:'6px 16px', marginBottom:32 }}>
                ...
                <span style={{ fontFamily:'Cabinet Grotesk, sans-serif', fontSize:11, fontWeight:600, letterSpacing:'0.15em', textTransform:'uppercase', color:'#E8780A' }}>Ventas Online · Paraguay</span>
              </div>
              ...
              <div style={{ display:'flex', gap:24, marginTop:48, flexWrap:'wrap' }}>
                {[
                  ...
                  <div key={i} style={{ display:'flex', alignItems:'center', gap:8 }}>
                    ...
                    <span style={{ fontFamily:'Cabinet Grotesk, sans-serif', fontSize:12, color:'rgba(255,255,255,0.35)', letterSpacing:'0.03em' }}>{b.text}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="hero-logo" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderRadius: 16, minHeight: 400 }}>
              ...
              {/* Radial mask so edges fade */}
              <div style={{
                position: 'absolute', inset: 0, zIndex: 1, borderRadius: 16,
                background: 'radial-gradient(ellipse at center, transparent 30%, #0F0F0F 80%)',
              }} />

              {/* Logo on top */}
              <div style={{ position: 'relative', zIndex: 2, filter: 'drop-shadow(0 0 60px rgba(232,120,10,0.5))' }}>
                <img src="/logo.png" alt="LIVOshop" style={{ width: 'clamp(180px, 22vw, 300px)', height: 'auto' }} />
              </div>
            </div>
        ...
        <div style={{ position:'relative', zIndex:2, display:'flex', justifyContent:'center', paddingBottom:32, alignItems:'center', gap:10 }}>
          ...
          <span style={{ fontFamily:'Cabinet Grotesk, sans-serif', fontSize:9, letterSpacing:'0.3em', textTransform:'uppercase', color:'rgba(255,255,255,0.2)' }}>Scroll</span>
        </div>
      </section>
      ...
      <div style={{ background:'#E8780A', overflow:'hidden', padding:'13px 0' }}>
        <div style={{ display:'flex', animation:'ticker 22s linear infinite', whiteSpace:'nowrap' }}>
          {Array(8).fill(TICKER_TEXT).map((t,i) => (
            <span key={i} style={{ fontFamily:'Bricolage Grotesque, sans-serif', fontSize:10, fontWeight:700, letterSpacing:'0.15em', color:'white', padding:'0 12px' }}>{t}</span>
          ))}
        </div>
      </div>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(220px,1fr))', gap:2 }}>
            {[
              ...
              <div key={i} style={{
                ...
                <h3 style={{ fontFamily:'Bricolage Grotesque, sans-serif', fontSize:13, fontWeight:700, color:'white', marginBottom:10, letterSpacing:'-0.3px' }}>{f.title}</h3>
        ...
        <div className="container">
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-end', marginBottom:56, flexWrap:'wrap', gap:24 }}>
            <div>
              <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:16 }}>
                ...
                <span style={{ fontFamily:'Cabinet Grotesk, sans-serif', fontSize:11, fontWeight:600, letterSpacing:'0.2em', textTransform:'uppercase', color:'#E8780A' }}>Catálogo</span>
              </div>
              <h2 style={{ fontFamily:'Bricolage Grotesque, sans-serif', fontSize:'clamp(32px,6vw,52px)', fontWeight:900, color:'#0F0F0F', letterSpacing:'-2px', lineHeight:0.95 }}>
          ...
          {loading ? (
            ...
            <div style={{ textAlign:'center', padding:'120px 0' }}>
              <p style={{ fontFamily:'Bricolage Grotesque, sans-serif', fontSize:18, fontWeight:700, color:'#0F0F0F', marginBottom:12 }}>Productos próximamente</p>
              ...
              <a href="https://wa.me/595991273055" target="_blank" rel="noreferrer" style={{
                ...
                borderRadius:4, fontFamily:'Cabinet Grotesk, sans-serif',
      ...
      <section style={{ background:'#0F0F0F', padding:'100px 0', position:'relative', overflow:'hidden' }}>
        ...
        <div className="container" style={{ position:'relative', textAlign:'center' }}>
          <p style={{ fontFamily:'Cabinet Grotesk, sans-serif', fontSize:11, fontWeight:600, letterSpacing:'0.2em', textTransform:'uppercase', color:'#E8780A', marginBottom:20 }}>¿No encontraste lo que buscás?</p>
          <h2 style={{ fontFamily:'Bricolage Grotesque, sans-serif', fontSize:'clamp(28px,5vw,52px)', fontWeight:900, color:'white', letterSpacing:'-2px', lineHeight:1, marginBottom:40 }}>
