    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ padding: '20px 24px', borderBottom: '1px solid #E8E4DE', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <h2 style={{ fontFamily: 'Clash Display, sans-serif', fontSize: '18px', fontWeight: 700 }}>Tu pedido</h2>
        ...
        {items.length > 0 && (
          <div style={{ padding: '20px 24px', borderTop: '1px solid #E8E4DE' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px' }}>
              ...
              <span style={{ fontSize: '18px', fontWeight: 700, fontFamily: 'Clash Display, sans-serif' }}>
