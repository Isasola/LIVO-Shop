        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 40, marginBottom: 40 }}>
          <div>
            <div style={{ marginBottom: 14 }}>
              <span style={{ fontFamily: 'Unbounded, sans-serif', fontWeight: 700, fontSize: 16, color: 'white' }}>LIVO</span>
              <span style={{ fontFamily: 'Unbounded, sans-serif', fontWeight: 400, fontSize: 16, color: '#E8780A' }}>shop</span>
            </div>
